...
inline void applyOrangeTheme()
{
    ...
    // base orange palette
    ImVec4 orange      = ImVec4(1.00f, 0.45f, 0.00f, 1.00f);  // bright orange
    ImVec4 orangeHigh  = ImVec4(1.00f, 0.60f, 0.10f, 1.00f);  // hover/active
    ImVec4 orangeMid   = ImVec4(0.60f, 0.25f, 0.00f, 1.00f);  // mid tone
    ImVec4 orangeLow   = ImVec4(0.25f, 0.10f, 0.00f, 1.00f);  // dark bg elements
    ImVec4 bg          = ImVec4(0.08f, 0.04f, 0.02f, 1.00f);  // near black bg
    ImVec4 bgWindow    = ImVec4(0.11f, 0.06f, 0.03f, 1.00f);  // window bg
    ImVec4 text        = ImVec4(1.00f, 0.95f, 0.90f, 1.00f);  // warm white text
    ...
    // rounding / spacing to match that tight monospace look
